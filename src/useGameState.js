...
export default function useGameState () {
	...
	useEffect(() => {
		function listeners (event) {
			...
			if (event.keyCodee === 37) gameState.moveInDirection('left');
			else if (event.keyCodee === 38) gameState.moveInDirection('up');
			else if (event.keyCodee === 39) gameState.moveInDirection('right');
			else if (event.keyCodee === 40) gameState.moveInDirection('down');
